...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "e825ae4b8b131f10e322";
...
"use strict";
eval("\r\nvar __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {\r\n    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;\r\n    if (typeof Reflect === \"object\" && typeof Reflect.decorate === \"function\") r = Reflect.decorate(decorators, target, key, desc);\r\n    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;\r\n    return c > 3 && r && Object.defineProperty(target, key, r), r;\r\n};\r\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\r\n    return new (P || (P = Promise))(function (resolve, reject) {\r\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\r\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\r\n        function step(result) { result.done ? resolve(result.value) : new P(function (resolve) { resolve(result.value); }).then(fulfilled, rejected); }\r\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\r\n    });\r\n};\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nconst competenceGoal_entity_1 = __webpack_require__(/*! ../competenceGoal.entity */ \"./src/competence-goal/competenceGoal.entity.ts\");\r\nconst typeorm_1 = __webpack_require__(/*! typeorm */ \"typeorm\");\r\nconst competenceGoal_entity_2 = __webpack_require__(/*! ../competenceGoal.entity */ \"./src/competence-goal/competenceGoal.entity.ts\");\r\nconst competence_goal_perf_model_1 = __webpack_require__(/*! ../models/competence-goal-perf.model */ \"./src/competence-goal/models/competence-goal-perf.model.ts\");\r\nconst js_joda_1 = __webpack_require__(/*! js-joda */ \"js-joda\");\r\nlet CompetenceGoalRepository = class CompetenceGoalRepository extends typeorm_1.MongoRepository {\r\n    saveActive(competenceGoal, startActive) {\r\n        return __awaiter(this, void 0, void 0, function* () {\r\n            competenceGoal.status = competenceGoal_entity_2.GoalStatus.ACTIVE;\r\n            competenceGoal.performance = new competence_goal_perf_model_1.ActiveGoalPerf(startActive);\r\n            const savedCompGoal = yield this.save(competenceGoal);\r\n            return savedCompGoal;\r\n        });\r\n    }\r\n    findActive(_competence) {\r\n        return __awaiter(this, void 0, void 0, function* () {\r\n            let queryResult = [];\r\n            const query = { status: competenceGoal_entity_2.GoalStatus.ACTIVE };\r\n            const cursor = this.createEntityCursor(query);\r\n            while (yield cursor.hasNext()) {\r\n                const compGoal = yield cursor.next();\r\n                if (compGoal.performance.needsToUpdateGoalPerf()) {\r\n                    const date = js_joda_1.LocalDate.from(js_joda_1.nativeJs(compGoal.performance._whenToAddDayPerf)).plusDays(7);\r\n                    const newdayPerfList = compGoal.performance.createGoalDayPerfList(compGoal.performance._whenToAddDayPerf);\r\n                    const newWhenToaddDayPerf = js_joda_1.convert(date).toDate();\r\n                    const update = { $push: { \"performance.goalDayPerf\": { $each: newdayPerfList } }, $set: { \"performance._whenToAddDayPerf\": newWhenToaddDayPerf } };\r\n                    const response = yield this.findOneAndUpdate({ _id: compGoal.id }, update, { maxTimeMS: 1000, returnOriginal: false });\r\n                    compGoal.performance = response.value.performance;\r\n                }\r\n                queryResult.push(compGoal);\r\n            }\r\n            return queryResult;\r\n        });\r\n    }\r\n};\r\nCompetenceGoalRepository = __decorate([\r\n    typeorm_1.EntityRepository(competenceGoal_entity_1.CompetenceGoal)\r\n], CompetenceGoalRepository);\r\nexports.CompetenceGoalRepository = CompetenceGoalRepository;\r\n\n\n//# sourceURL=webpack:///./src/competence-goal/repositories/competence-goal.repository.ts?");
...
eval("throw new Error(\"Module parse failed: Identifier 'value' has already been declared (69:153)\\nYou may need an appropriate loader to handle this file type.\\n|         return __awaiter(this, void 0, void 0, function* () {\\r\\n|             let updateField = `goalWeekPerf.$.daysGaolPerf.${dayOfWeek}`;\\r\\n>             const compGoal = yield this.competenceGoalRepository.findByIds({ _id: comGoal_Id }), { $inc: { [updateField]: value, \\\"goalPerf.overallPerf\\\": value } };\\r\\n|             return upd.nModified;\\r\\n|         });\\r\");\n\n//# sourceURL=webpack:///./src/competence-goal/services/competence-goal.service.ts?");
